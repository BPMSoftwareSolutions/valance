      ...
      beats: [
        {
          ...
          description:
            "Detects element selection context and prepares for coordination. Identifies the target element, validates selection permissions, and initializes selection state management.",
        ...
        },
        {
          ...
          description:
            "Processes element selection with visual feedback and state management. Updates selection state, manages multi-select operations, and coordinates with other Canvas elements.",
        ...
        },
        {
          ...
          description:
            "Coordinates visual feedback for selected elements. Updates selection indicators, manages highlight states, and synchronizes visual cues across the canvas interface.",
          dynamics: MUSICAL_DYNAMICS.MEZZO_FORTE,
        ...
        },
        {
          ...
          description:
            "Manages selection state persistence and coordination. Updates global selection state, handles selection history, and coordinates with other system components.",
          dynamics: MUSICAL_DYNAMICS.FORTE,
          timing: MUSICAL_TIMING.IMMEDIATE,
