...
export { default as handleCanvasElementCreated, handleCanvasElementPositioned } from './handlers/onElementCreate';

// Business logic
export { validateDropContext } from './logic/dropValidation';

// React hooks
export { useCanvasLibraryDrop, default as useCanvasLibraryDropDefault } from './hooks';
...
export const CIAPlugin = {
  mount: (conductor: any, eventBus: any) => {
    ...
    try {
      ...
      eventBus.subscribe('canvas:element:position', handleCanvasElementPositioned);
  ...
  unmount: (conductor: any, eventBus: any) => {
    ...
    try {
      ...
      eventBus.unsubscribe('canvas:drop:validation', handleCanvasDropValidation);
      eventBus.unsubscribe('canvas:element:create', handleCanvasElementCreated);
      eventBus.unsubscribe('canvas:element:position', handleCanvasElementPositioned);
