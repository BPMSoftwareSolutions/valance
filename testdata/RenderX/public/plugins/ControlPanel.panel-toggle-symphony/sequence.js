...
__export(stdin_exports, {
  LAYOUT_MODE_CHANGE_SEQUENCE: () => LAYOUT_MODE_CHANGE_SEQUENCE,
  PANEL_TOGGLE_SEQUENCE: () => PANEL_TOGGLE_SEQUENCE,
  startLayoutModeChangeFlow: () => startLayoutModeChangeFlow,
  startPanelToggleFlow: () => startPanelToggleFlow
});
...
var LAYOUT_MODE_CHANGE_SEQUENCE = {
...
var startPanelToggleFlow = (conductor, panelType, newState, options = {}) => {
...
var startLayoutModeChangeFlow = (conductor, newMode, options = {}) => {
