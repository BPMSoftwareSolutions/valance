...
__export(stdin_exports, {
  JSON_COMPONENT_ERROR_SEQUENCE: () => JSON_COMPONENT_ERROR_SEQUENCE,
  JSON_COMPONENT_LOADING_SEQUENCE: () => JSON_COMPONENT_LOADING_SEQUENCE,
  startJsonComponentErrorFlow: () => startJsonComponentErrorFlow,
  startJsonComponentLoadingFlow: () => startJsonComponentLoadingFlow
});
...
var JSON_COMPONENT_LOADING_SEQUENCE = {
...
var JSON_COMPONENT_ERROR_SEQUENCE = {
...
var startJsonComponentLoadingFlow = (conductor, componentFiles, options = {}) => {
...
var startJsonComponentErrorFlow = (conductor, error, context) => {
